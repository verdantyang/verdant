...
wget http://10.168.73.68:17878/download/nginx-1.10.2-os65.tar.gz -O /tmp/nginx-1.10.2-os65.tar.gz
tar xzf /tmp/nginx-1.10.2-os65.tar.gz -C /opt/src/
...
/bin/rm -rf /tmp/nginx-1.10.2-os65.tar.gz
