...
public class ConsistHash<S> {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Long> map1 = (Map<String, Long>)result1.stream().collect(Collectors.groupingBy(p -> p, Collectors.counting()));
        System.out.println("result1: ");
        map1.forEach((k, v) -> System.out.println(k + ": " + v));
        System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~");

        Map<String, Long> map2 = (Map<String, Long>)result2.stream().collect(Collectors.groupingBy(p -> p, Collectors.counting()));
        System.out.println("result2: ");
        map2.forEach((k, v) -> System.out.println(k + ": " + v));
        System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~");

        Map<String, Long> map3 = (Map<String, Long>)result3.stream().collect(Collectors.groupingBy(p -> p, Collectors.counting()));
