...
import static com.verdant.demo.algo.MerkleBTree.LEAF_SIG_TYPE;
...
import com.verdant.demo.algo.MerkleBTree.Node;
...
public final class MerkleDeserializer {
    ...
    /**
     * Deserialize works from a byte array generated by {@link MerkleBTree#serialize()}.
     ...
     * @return
     */
    public static MerkleBTree deserialize(byte[] serializedTree) {
        ByteBuffer buf = ByteBuffer.wrap(serializedTree);

    /* ---[ read header ]--- */
        if (buf.getInt() != MerkleBTree.MAGIC_HDR) {
    ...
    /* ---[ read data ]--- */
        ...
        return new MerkleBTree(root, totnodes, height, leafSigs);
    }
