...
import com.verdant.demo.algo.MerkleDeserializer;
import com.verdant.demo.algo.MerkleBTree;
import org.junit.Test;

public class MerkleBTreeTest {

    @Test
    public void testConstructTree_4LeafEntries() {
        MerkleBTree m4tree = construct4LeafTree();

        MerkleBTree.Node root = m4tree.getRoot();
        ByteBuffer buf = ByteBuffer.allocate(8);
        buf.put(root.sig);
        buf.rewind();
        // pop off the leading 0 or 1 byte
        assertEquals(MerkleBTree.INTERNAL_SIG_TYPE, root.type);
        long rootSig = buf.getLong();
        assertTrue(rootSig > 1);

        assertEquals(2, m4tree.getDepth());
        assertEquals(7, m4tree.getNumNodes());

        MerkleBTree.Node lev1Node0 = root.left;
        assertEquals(MerkleBTree.INTERNAL_SIG_TYPE, lev1Node0.type);

        MerkleBTree.Node lev1Node1 = root.right;
        assertEquals(MerkleBTree.INTERNAL_SIG_TYPE, lev1Node1.type);

        MerkleBTree.Node lev2Node0 = lev1Node0.left;
        assertEquals(MerkleBTree.LEAF_SIG_TYPE, lev2Node0.type);
        assertEquals("52e422506d8238ef3196b41db4c41ee0afd659b6", new String(lev2Node0.sig, UTF_8));

        MerkleBTree.Node lev2Node1 = lev1Node0.right;
        assertEquals(MerkleBTree.LEAF_SIG_TYPE, lev2Node1.type);
        assertEquals("6d0b51991ac3806192f3cb524a5a5d73ebdaacf8", new String(lev2Node1.sig, UTF_8));

        MerkleBTree.Node lev2Node2 = lev1Node1.left;
        assertEquals(MerkleBTree.LEAF_SIG_TYPE, lev2Node2.type);
        assertEquals("461848c8b70e5a57bd94008b2622796ec26db657", new String(lev2Node2.sig, UTF_8));

        MerkleBTree.Node lev2Node3 = lev1Node1.right;
        assertEquals(MerkleBTree.LEAF_SIG_TYPE, lev2Node3.type);
    ...
    public void test4and8LeafTreesHaveDifferentRootSigs() {
        MerkleBTree m4tree = construct4LeafTree();
        MerkleBTree m8tree = construct8LeafTree();
    ...
    public void testConstructTree_8LeafEntries() {
        ...
        MerkleBTree.Node root = m8tree.getRoot();
        ByteBuffer buf = ByteBuffer.allocate(8);
        buf.put(root.sig);
        buf.rewind();
        // pop off the leading 0 or 1 byte
        ...
        assertEquals(3, m8tree.getDepth());
        ...
        MerkleBTree.Node lev2Node2 = lev1Node1.left;
        MerkleBTree.Node lev2Node3 = lev1Node1.right;
        assertEquals(MerkleBTree.INTERNAL_SIG_TYPE, lev2Node0.type);
        assertEquals(MerkleBTree.INTERNAL_SIG_TYPE, lev2Node1.type);
        assertEquals(MerkleBTree.INTERNAL_SIG_TYPE, lev2Node2.type);
        assertEquals(MerkleBTree.INTERNAL_SIG_TYPE, lev2Node3.type);

        MerkleBTree.Node lev3Node0 = lev2Node0.left;
        MerkleBTree.Node lev3Node1 = lev2Node0.right;
        MerkleBTree.Node lev3Node2 = lev2Node1.left;
        MerkleBTree.Node lev3Node3 = lev2Node1.right;
        MerkleBTree.Node lev3Node4 = lev2Node2.left;
        MerkleBTree.Node lev3Node5 = lev2Node2.right;
        MerkleBTree.Node lev3Node6 = lev2Node3.left;
        MerkleBTree.Node lev3Node7 = lev2Node3.right;

        assertEquals(MerkleBTree.LEAF_SIG_TYPE, lev3Node0.type);
        assertEquals(MerkleBTree.LEAF_SIG_TYPE, lev3Node1.type);
        assertEquals(MerkleBTree.LEAF_SIG_TYPE, lev3Node2.type);
        assertEquals(MerkleBTree.LEAF_SIG_TYPE, lev3Node3.type);
        assertEquals(MerkleBTree.LEAF_SIG_TYPE, lev3Node4.type);
        assertEquals(MerkleBTree.LEAF_SIG_TYPE, lev3Node5.type);
        assertEquals(MerkleBTree.LEAF_SIG_TYPE, lev3Node6.type);
        assertEquals(MerkleBTree.LEAF_SIG_TYPE, lev3Node7.type);
    ...
    public void testConstructTree_9LeafEntries() {
        MerkleBTree m9tree = construct9LeafTree();

        MerkleBTree.Node root = m9tree.getRoot();
        ByteBuffer buf = ByteBuffer.allocate(8);
        buf.put(root.sig);
        buf.rewind();
        // pop off the leading 0 or 1 byte
        ...
        assertEquals(4, m9tree.getDepth());
        ...
        MerkleBTree.Node lev3Node4 = lev2Node2.left;
        assertEquals(MerkleBTree.INTERNAL_SIG_TYPE, lev3Node4.type);
        assertArrayEquals(lev2Node2.sig, lev3Node4.sig);

        assertNull(lev3Node4.right);
        MerkleBTree.Node lev4Node8 = lev3Node4.left;
        assertEquals(MerkleBTree.LEAF_SIG_TYPE, lev4Node8.type);
        assertArrayEquals(lev3Node4.sig, lev4Node8.sig);

        // check some of the left hand trees to ensure correctness
        MerkleBTree.Node lev2Node0 = lev1Node0.left;
        MerkleBTree.Node lev3Node1 = lev2Node0.right;
        MerkleBTree.Node lev4Node3 = lev3Node1.right;

        assertEquals(MerkleBTree.INTERNAL_SIG_TYPE, lev2Node0.type);
        assertEquals(MerkleBTree.INTERNAL_SIG_TYPE, lev3Node1.type);
        assertEquals(MerkleBTree.LEAF_SIG_TYPE, lev4Node3.type);
    ...
    public void testConstructTree_10LeafEntries() {
        MerkleBTree m9tree = construct10LeafTree();
        ...
        MerkleBTree.Node lev4Node9 = lev3Node4.left;
        assertEquals(MerkleBTree.LEAF_SIG_TYPE, lev4Node9.type);
    ...
    public void testMerkleCanDetectOutOfOrderMessages() {
        MerkleBTree order1m = construct4LeafTree();
        MerkleBTree order2m = construct4LeafTreeOrder2();
        MerkleBTree order3m = construct4LeafTreeOrder3();
        MerkleBTree order3mb = construct4LeafTreeOrder3();
  ...
  /* ---[ ser / deserialization tests ]--- */
    ...
    public void testSerializationDeserialization4LeafTree() {
        ...
        assertEquals(MerkleBTree.MAGIC_HDR, buf.getInt());
        assertEquals(m4tree.getNumNodes(), buf.getInt());

        // root node
        MerkleBTree.Node root = new MerkleBTree.Node();
        root.type = buf.get();
        assertEquals(MerkleBTree.INTERNAL_SIG_TYPE, root.type);
        int len = buf.getInt();
        assertEquals(MerkleBTree.LONG_BYTES, len);
        ...
        MerkleBTree dtree = MerkleDeserializer.deserialize(serializedTree);
        assertEquals(MerkleBTree.INTERNAL_SIG_TYPE, dtree.getRoot().type);
        assertArrayEquals(root.sig, dtree.getRoot().sig);

        root = dtree.getRoot();

        assertEquals(2, dtree.getDepth());
    ...
    public void testSerializationDeserialization2LeafTree() {
        MerkleBTree m2tree = construct2LeafTree();
        ...
        assertEquals(1, dtree.getDepth());
        assertEquals(3, dtree.getNumNodes());

        root = dtree.getRoot();
        MerkleBTree.Node lev1Node0 = root.left;
        assertEquals(MerkleBTree.LEAF_SIG_TYPE, lev1Node0.type);
        assertNull(lev1Node0.left);
        assertNull(lev1Node0.right);

        MerkleBTree.Node lev1Node1 = root.right;
        assertEquals(MerkleBTree.LEAF_SIG_TYPE, lev1Node1.type);
    ...
    public void testSerializationDeserialization1019LeafTree() {
        MerkleBTree m1019tree = construct1019LeafTree();
        ...
        assertEquals(10, m1019tree.getDepth());
        ...
        assertEquals(10, dtree.getDepth());
  ...
  /* ---[ helper methods ]--- */
    ...
    MerkleBTree construct9LeafTree() {
        List<String> signatures = Arrays.asList(
                "52e422506d8238ef3196b41db4c41ee0afd659b6",
    ...
    MerkleBTree construct10LeafTree() {
        List<String> signatures = Arrays.asList(
                "52e422506d8238ef3196b41db4c41ee0afd659b6",
                "6d0b51991ac3806192f3cb524a5a5d73ebdaacf8",
                "461848c8b70e5a57bd94008b2622796ec26db657",
    ...
    MerkleBTree construct8LeafTree() {
        List<String> signatures = Arrays.asList(
                "52e422506d8238ef3196b41db4c41ee0afd659b6",
                "6d0b51991ac3806192f3cb524a5a5d73ebdaacf8",
                "461848c8b70e5a57bd94008b2622796ec26db657",
    ...
    MerkleBTree construct4LeafTree() {
        List<String> signatures = Arrays.asList(
                "52e422506d8238ef3196b41db4c41ee0afd659b6",
                "6d0b51991ac3806192f3cb524a5a5d73ebdaacf8",
                "461848c8b70e5a57bd94008b2622796ec26db657",
    ...
    MerkleBTree construct4LeafTreeOrder2() {
    ...
    MerkleBTree construct4LeafTreeOrder3() {
