package com.verdant.jtools.common.file.pdf;
...
//                        PropUtil.get("html.exporter.webdriver.chrome.driver")));
        ...
        phantomCaps.setCapability("phantomjs.page.settings.userAgent",
                SpringPropUtils.get("html.exporter.user.agent"));

        PhantomJSDriver driver = new PhantomJSDriver(phantomCaps);
//        driver.manage().timeouts().implicitlyWait(Integer.valueOf(SpringPropUtils.getInstance()
//                .getProperty("html.exporter.driver.timeouts.implicitly.seconds")), TimeUnit.SECONDS);
//        driver.manage().timeouts().pageLoadTimeout(Integer.valueOf(SpringPropUtils.getInstance()
//                .getProperty("html.exporter.driver.timeouts.page.load.seconds")), TimeUnit.SECONDS);
//        driver.manage().timeouts().setScriptTimeout(Integer.valueOf(SpringPropUtils.getInstance()
//                .getProperty("html.exporter.driver.timeouts.script.seconds")), TimeUnit.SECONDS);
        ...
        try {
            ...
            Thread.sleep(Integer.valueOf(SpringPropUtils.get("html.exporter.driver.timeouts.implicitly.seconds")) * 1000);
