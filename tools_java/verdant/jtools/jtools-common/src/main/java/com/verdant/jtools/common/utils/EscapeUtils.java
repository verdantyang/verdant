...
public class EscapeUtils {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                unescape("%7B%27id%27%3A1%2C%27parentId%27%3A2%2C%27name%27%3A%27%u6D4B%u8BD5%u6837%u4F8B%27%2C%27dataSource%27%3A%2720%27%2C%27path%27%3A%272/1.rep%27%7D"));
        System.out.println(
                escape("{'id':1,'parentId':2,'name':'测试样例','dataSource':'20','path':'2/1.rep'}"));
    }
}
